...
```sh
x install aks-engine
```

## Code insight

Total: **1,455,075** lines of code across **4224** files in the top 5 languages.

| Language | Code | Comments | Blanks | Files |
|----------|-----:|---------:|-------:|------:|
| Go | 1,334,577 | 192,502 | 116,759 | 3692 |
| Json | 76,263 | 0 | 9 | 291 |
| Yaml | 18,573 | 790 | 456 | 127 |
| AssemblyGAS | 7,451 | 704 | 2,137 | 56 |
| Protobuf | 7,161 | 12,967 | 3,791 | 58 |
...
- **Upstream**: <https://github.com/Azure/aks-engine>
- **Homepage**: <https://github.com/Azure/aks-engine>
- **License**: MIT

## Release

- **Latest**: `v0.79.0` (2023-08-31)
- **Last commit**: 2023-10-24
- **Assets in release**: 6

## Popularity

- **Stars**: 1,021 · **Forks**: 507 · **Open issues**: 1,561 · **Contributors**: 3,060

## Totals (cumulative)

- **Releases**: 142 · **Merged PRs**: 3090 · **Open PRs**: 0 · **Closed issues**: 1561 · **Open issues**: 0 · **Commits**: 5523
...
Reported by **2** distros on [repology.org](https://repology.org/project/aks-engine). **1** are ✅ on the latest upstream release, **1** are ⚠️ on an older version.

## Improve this data

Install metadata for aks-engine lives in the [x-cmd/install](https://github.com/x-cmd/install) index — a curated YAML package list that x-cmd consumes at install time. If `aks-engine` is missing, out of date, or installs incorrectly, please open an issue or PR there:

- **Open an issue**: <https://github.com/x-cmd/install/issues/new>
- **Edit the package entry**: <https://github.com/x-cmd/install/edit/main/aks-engine.yml> (or whichever path the index uses)

The data on this page (card / loc / scorecard / release) is auto-collected by [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) and is regenerated daily. Improvements to *install behaviour* (which version gets installed, platform-specific quirks, dependencies) belong upstream in the index.

_Snapshot: `data/card/260911.yml` · 2026-09-11T04:25:41Z._
